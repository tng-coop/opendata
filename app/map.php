...
<script>
    ...
    foreach ($coordinates as $coordinate) {
        ...
        echo "var marker = L.marker([{$coordinate['latitude']}, {$coordinate['longitude']}]).addTo(mymap);";
        echo "marker.bindPopup('<a href=\"' + " . json_encode($url) . " + '\" target=\"_blank\">' + " . json_encode($coordinate['name']) . " + '</a>');";
    }
    ?>
