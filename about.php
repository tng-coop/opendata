<style>
        .explanation {
            width: 100%; /* Box takes full width, with text aligned to the right */
            cursor: pointer;
            text-align: right;
            transition: all 0.3s ease;
        }
        .explanation p {
            display: none; /* Hide full message initially */
            text-align: left;
            padding: 10px;
            margin-top: 5px; /* Space between title and expanded content */
